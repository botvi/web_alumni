            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="service-item position-relative">
                    ...
                    <div class="p-3">
                        ...
                        <p class="text-center">{!! Str::limit($item->deskripsi_kegiatan, 100) !!}</p>
                        <div class="text-center mt-3">
                            <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalKegiatan{{ $item->id }}">Baca Selengkapnya</a>
                        </div>
                    </div>
                </div>
            </div>
