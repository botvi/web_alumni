                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Master Lowongan Pekerjaan</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Edit Master Lowongan Pekerjaan</h5>
                            </div>
                            <hr>
                            <form action="{{ route('master_lowongan.update', $lowongan->id) }}" method="POST" class="row g-3" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="nama_perusahaan" name="nama_perusahaan"
                                        value="{{ $lowongan->nama_perusahaan }}" required>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="nama_lowongan" name="nama_lowongan"
                                        value="{{ $lowongan->nama_lowongan }}" required>
                                    <small class="text-danger">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="deskripsi" name="deskripsi" required>{{ $lowongan->deskripsi }}</textarea>
                                    <small class="text-danger">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="persyaratan" name="persyaratan" required>{{ $lowongan->persyaratan }}</textarea>
                                    <small class="text-danger">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="gaji" name="gaji" value="{{ $lowongan->gaji }}" required>
                                    <small class="text-danger">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="date" class="form-control" id="tanggal_penutupan"
                                        name="tanggal_penutupan" value="{{ $lowongan->tanggal_penutupan }}" required>
                                    <small class="text-danger">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="email" class="form-control" id="email_perusahaan" name="email_perusahaan"
                                        value="{{ $lowongan->email_perusahaan }}" >
                                    <small class="text-danger">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="whatsapp_perusahaan" name="whatsapp_perusahaan" placeholder="6281234567890"
                                        value="{{ $lowongan->whatsapp_perusahaan }}" >
                                    <small class="text-danger">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="website_perusahaan" name="website_perusahaan"
                                        value="{{ $lowongan->website_perusahaan }}" >
                                    <small class="text-danger">
